...
static RendererVtable noopVtable = {
    .init = noopInit,
    .destroy = noopDestroy,
    .beginFrame = noopBeginFrame,
    .endFrameInit = noopEndFrameInit,
    .endFrameEnd = noopEndFrameEnd,
    .beginView = noopBeginView,
    .endView = noopEndView,
    .applyProjection = noopApplyProjection,
    .beginGUI = noopBeginGUI,
    .setGuiProjection = noopSetGuiProjection,
    .endGUI = noopEndGUI,
    .drawSprite = noopDrawSprite,
    .drawSpritePart = noopDrawSpritePart,
    .drawSpritePartColor = noopDrawSpritePartColor,
    .drawSpritePos = noopDrawSpritePos,
    .drawRectangle = noopDrawRectangle,
    .drawRectangleColor = noopDrawRectangleColor,
    .drawLine = noopDrawLine,
    .drawTriangle = noopDrawTriangle,
    .drawLineColor = noopDrawLineColor,
    .drawText = noopDrawText,
    .drawTextColor = noopDrawTextColor,
    .flush = noopFlush,
    .clearScreen = noopClearScreen,
    .createSpriteFromSurface = noopCreateSpriteFromSurface,
    .deleteSprite = noopDeleteSprite,
    .gpuGetBlendFactors = noopGpuGetBlendFactors,
    .gpuGetBlendMode = noopGpuGetBlendMode,
    .gpuSetBlendMode = noopGpuSetBlendMode,
    .gpuSetBlendModeExt = noopGpuSetBlendModeExt,
    .gpuSetBlendEnable = noopGpuSetBlendEnable,
    .gpuSetAlphaTestEnable = noopGpuSetAlphaTestEnable,
    .gpuGetAlphaTestEnable = noopGpuGetAlphaTestEnable,
    .gpuSetAlphaTestRef = noopGpuSetAlphaTestRef,
    .gpuSetColorWriteEnable = noopGpuSetColorWriteEnable,
    .gpuGetColorWriteEnable = noopGpuGetColorWriteEnable,
    .gpuGetBlendEnable = noopGpuGetBlendEnable,
    .gpuSetFog = noopGpuSetFog,
    .drawTile = noopDrawTile,
    .drawSpriteTiled = noopDrawSpriteTiled,
    .createSurface = noopCreateSurface,
    .surfaceExists = noopSurfaceExists,
    .setRenderTarget = noopSetRenderTarget,
    .ensureApplicationSurface = noopEnsureApplicationSurface,
    .getSurfaceWidth = noopGetSurfaceWidth,
    .getSurfaceHeight = noopGetSurfaceHeight,
    .drawSurface = noopDrawSurface,
    .drawSurfaceColor = noopDrawSurfaceColor,
    .drawSurfaceTiled = noopDrawSurfaceTiled,
    .surfaceResize = noopSurfaceResize,
    .surfaceFree = noopSurfaceFree,
    .surfaceCopy = noopSurfaceCopy,
    .surfaceGetPixels = noopSurfaceGetPixels,
    .drawTiledPart = noopDrawTiledPart,
    .gpuSetShader = noopGpuSetShader,
    .gpuResetShader = noopGpuResetShader,
    .shaderGetUniform = noopShaderGetUniform,
    .shaderGetSamplerIndex = noopShaderGetSamplerIndex,
    .shaderSetUniformF = noopShaderSetUniformF,
    .shaderSetUniformFArray = noopShaderSetUniformFArray,
    .shaderSetUniformI = noopShaderSetUniformI,
    .spriteGetTexture = noopSpriteGetTexture,
    .surfaceGetTexture = noopSurfaceGetTexture,
    .textureGetTexelWidth = noopTextureGetTexelWidth,
    .textureGetTexelHeight = noopTextureGetTexelHeight,
    .textureGetUVs = noopTextureGetUVs,
    .textureSetStage = noopTextureSetStage,
    .shaderIsCompiled = noopShaderIsCompiled,
    .shadersSupported = noopShadersSupported,
    .setMatrix = noopSetMatrix,
};
